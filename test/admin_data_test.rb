...
require File.expand_path(File.join(File.dirname(__FILE__), '../../../../vendor/plugins/admin_data/lib/admin_data_date_validation'))
...
class AdminDataTest < Test::Unit::TestCase
  ...
  def test_date_validation
    ...
    assert ::AdminDataDateValidation.validate('13-FEBfoo-2009')  # only the first three characters of the month should be checked
