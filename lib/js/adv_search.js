...
var AdminDataJSUtil = (function($) {
  return {
    ...
    disableCol3: function(tr_id){
      $('#'+tr_id+'_ram_input_field_col3').val('').attr('disabled', true);
    },
    ...
    changeCol3: function(tr_id,table_structure){
      ...
      if (col2_value.length > 0){
        if (
          ...
          var col1_value = $('#'+tr_id+'_ram_drop_down_col1').val();
          var col1_type = table_structure[col1_value];
        ...
        target_element.attr('disabled', true).addClass('disabled');                        
      }
    },
