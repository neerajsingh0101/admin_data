$(function() {
	...
	var table_structure_data_non_json = $('#admin_data_table_structure_data').html(),
	table_structure_data_json = $.parseJSON(table_structure_data_non_json);


  log(table_structure_data_non_json);

	$('#advance_search_table').data('table_structure', table_structure_data_json);
