...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-08-15}
  s.description = %q{Dynamic scaffolding for Rails}
  ...
  s.files = [
    "History.txt",
     ...
     "test/rails_root/public/tmp/response.txt",
  ...
  s.summary = %q{Dynamic scaffolding for Rails}
  s.test_files = [
    "test/factories/article.rb",
     "test/factories/car.rb",
     "test/factories/city.rb",
