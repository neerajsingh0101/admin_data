class AdminData::MainController  < ApplicationController
   ...
   def advance_search
      ...
      respond_to do |format|
         format.html { render }
         format.js {
            render :file => "#{RAILS_ROOT}/vendor/plugins/admin_data/app/views/admin_data/main/search/_search_results.html.erb"
         }
      end
   end
